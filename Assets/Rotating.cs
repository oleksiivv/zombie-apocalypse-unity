...
public class Rotating : MonoBehaviour
{
  ...
  public Joystick stick;
    ...
    void Update()
    {
     ...
     if(GetComponent<PlayerController>().die==false && GetComponent<PlayerController>().win==false && move && Time.timeScale==1 && Input.GetMouseButton(0) && (stick.Horizontal!=0 || stick.Vertical!=0)){
